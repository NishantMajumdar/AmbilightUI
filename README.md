...
1. Uses Win8 Desktop Duplication for Ambient lighting.
2. Uses OpenHardwareMonitor for GPU temperature detection, changes color of external RGB LED accordingly, from Green to Red.
3. Uses Light Dependent Resistor in pin A0, to automatically turn on lights when room becomes dark.
4. Has other lighting effects for the strip including static and animated effects.
5. External RGB color can be manually changed.
