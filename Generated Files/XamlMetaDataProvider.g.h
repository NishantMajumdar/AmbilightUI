...
namespace winrt::AmbilightUI::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, AmbilightUI::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = AmbilightUI::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"AmbilightUI.XamlMetaDataProvider";
        }
    };
}
namespace winrt::AmbilightUI::factory_implementation
{
    ...
    {
        using instance_type = AmbilightUI::XamlMetaDataProvider;
