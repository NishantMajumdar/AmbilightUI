...
namespace winrt::AmbilightUI::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, AmbilightUI::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = AmbilightUI::MainWindow;
        ...
        {
            return L"AmbilightUI.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::AmbilightUI::factory_implementation
{
    ...
    {
        using instance_type = AmbilightUI::MainWindow;
