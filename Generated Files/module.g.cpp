...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"AmbilightUI.MainWindow"))
    {
        return winrt_make_AmbilightUI_MainWindow();
    }

    if (requal(name, L"AmbilightUI.XamlMetaDataProvider"))
    {
        return winrt_make_AmbilightUI_XamlMetaDataProvider();
    }
